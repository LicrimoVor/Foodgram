...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='ingredient',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.SET_DEFAULT, related_name='ingredient_recipe', to='recipe.ingredientmodel', verbose_name='Ингредиент (id)'),
        ),
        migrations.AddField(
            model_name='ingredientrecipemodel',
            name='recipe',
